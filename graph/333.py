...
beverages = {
    ...
    'Freshly chilled lemon water': np.array([-0.5092,-0.4109,-0.2935]),
...
plt.title('Absorbance vs. Wavelength for Freshly chilled lemon water in the Yuquan Road Canteen')
